    ...
    while State.FlingAura do
        ...
        if hrp then
            ...
            if targetHrp then
                ...
                -- Bypass Anti-Fling musuh dengan memperberat massa karakter
                hrp.CustomPhysicalProperties = PhysicalProperties.new(100, 0.3, 0.5, 1, 1)
...
track(RunService.Stepped:Connect(function()
    if State.AntiFling then
        -- Jangan aktifkan anti-fling saat sedang menjadi hantu (FlingAura/AutoAssassin) atau TouchFling/LockFling
        -- karena kita butuh velocity ekstrem untuk melempar musuh tanpa nge-anchor diri sendiri
        if not State.FlingAura and not State.TouchFling and not State.LockFling and hitAndRunBtn.Text == "Auto Assassin" then
